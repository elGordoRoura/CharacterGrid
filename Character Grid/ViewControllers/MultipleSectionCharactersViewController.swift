...
class MultipleSectionCharactersViewController: UIViewController {
    ...
    private func setupCollectionView() {
        ...
        headerRegistration = UICollectionView.SupplementaryRegistration(elementKind: UICollectionView.elementKindSectionHeader, handler: { (header: HeaderView, _, indexPath) in
            let section = self.sectionedCharacters[indexPath.section]
